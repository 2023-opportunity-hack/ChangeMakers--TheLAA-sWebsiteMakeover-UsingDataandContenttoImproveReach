 ...
 * @since 6.2.0
 */
var WP_HTML_Tag_Processor = (function() {
            var __private = __PRIVATIZE__();
            var __skip_rcdata = function(tag_name) {
                var html;
                html = this.html;
                var doc_length;
                ...
                var at;
                at = __private(this).bytes_already_parsed;
                __loop1:
                    while (false !== at && at < doc_length) {
                        at = strpos(this.html, "</", at);
                        // If there is no possible tag closer then fail.
                        if (false === at || at + tag_length >= doc_length) {
                            __private(this).bytes_already_parsed = doc_length;
                            return false;
                        }
                        var closer_potentially_starts_at;
                        ...
                        at += tag_length;
                        __private(this).bytes_already_parsed = at;
                        /*
                        ...
                        __loop2:
                            while (__private(this).parse_next_attribute.call(this)) {
                                continue;
                            }
                        at = __private(this).bytes_already_parsed;
                        ...
                        if (">" === html[at] || "/" === html[at]) {
                            __private(this).bytes_already_parsed = closer_potentially_starts_at;
                            return true;
                        }
                    }
                return false;
            };
            var __skip_script_data = function() {
                var state;
                state = "unescaped";
                var html;
                html = this.html;
                ...
                __loop1:
                    while (false !== at && at < doc_length) {
                        ...
                        if (is_closing) {
                            __private(this).bytes_already_parsed = closer_potentially_starts_at;
                            if (__private(this).bytes_already_parsed >= doc_length) {
                                return false;
                            }
                            __loop2:
                                while (__private(this).parse_next_attribute.call(this)) {
                            ...
                            if (">" === html[__private(this).bytes_already_parsed]) {
                                __private(this).bytes_already_parsed = closer_potentially_starts_at;
                                return true;
                            }
                        }
            ...
            var __parse_next_tag = function() {
                    __private(this).after_tag.call(this);
                    var html;
                    html = this.html;
                    var doc_length;
                    doc_length = strlen(html);
                    ...
                    __loop1:
                        while (false !== at && at < doc_length) {
                            ...
                            if ("/" === this.html[at + 1]) {
                                __private(this).is_closing_tag = true;
                                at++;
                            } else {
                                __private(this).is_closing_tag = false;
                            }
                            /*
                             ...
                             */
                            var tag_name_prefix_length;
                            tag_name_prefix_length = strspn(html, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", at + 1);
                            if (tag_name_prefix_length > 0) {
                                ++at;
                                __private(this).tag_name_length = tag_name_prefix_length + strcspn(html, " 	\
                                    n\ /
                                    > ", at + tag_name_prefix_length);
                                    __private(this).tag_name_starts_at = at; __private(this).bytes_already_parsed = at + __private(this).tag_name_length;
                                    return true;
                                }
                                /*
                                ...
                                if ("!" === html[at + 1]) {
                                    ...
                                    if (strlen(html) > at + 3 && "-" === html[at + 2] && "-" === html[at + 3]) {
                                         ...
                                         */
                                        closer_at--;
                                        // Pre-increment inside condition below reduces risk of accidental infinite looping.
                                        __loop2:
                                 ...
                                 */
                                if (__private(this).is_closing_tag) {
                    ...
                    var __parse_next_attribute = function() {
                            // Skip whitespace and slashes.
                            __private(this).bytes_already_parsed += strspn(this.html, " 	\
                                    n\ /
                                    ", __private(this).bytes_already_parsed);
                                    if (__private(this).bytes_already_parsed >= strlen(this.html)) {
                                        return false;
                                    }
                                    /*
                                     ...
                                     */
                                    var name_length; name_length = "=" === this.html[__private(this).bytes_already_parsed] ? 1 + strcspn(this.html, "=/> 	\
                                        n\ ", __private(this).bytes_already_parsed + 1):strcspn(this.html, " = /> 	\
                                        n\ ", __private(this).bytes_already_parsed);
                                        // No attribute, just tag closer.
                                        if (0 === name_length || __private(this).bytes_already_parsed + name_length >= strlen(this.html)) {
                                            return false;
                                        }
                                        var attribute_start; attribute_start = __private(this).bytes_already_parsed;
                                        var attribute_name; attribute_name = substr(this.html, attribute_start, name_length); __private(this).bytes_already_parsed += name_length;
                                        if (__private(this).bytes_already_parsed >= strlen(this.html)) {
                                            return false;
                                        }
                                        __private(this).skip_whitespace.call(this);
                                        if (__private(this).bytes_already_parsed >= strlen(this.html)) {
                                            return false;
                                        }
                                        var has_value; has_value = "=" === this.html[__private(this).bytes_already_parsed];
                                        if (has_value) {
                                            ++__private(this).bytes_already_parsed;
                                            __private(this).skip_whitespace.call(this);
                                            if (__private(this).bytes_already_parsed >= strlen(this.html)) {
                                            ...
                                            __loop1:
                                                switch (this.html[__private(this).bytes_already_parsed]) {
                                                    case "'":
                                                    case "\"":
                                                        var quote;
                                                        quote = this.html[__private(this).bytes_already_parsed];
                                                        var value_start;
                                                        value_start = __private(this).bytes_already_parsed + 1;
                                                        var value_length;
                                                        value_length = strcspn(this.html, quote, value_start);
                                                        var attribute_end;
                                                        attribute_end = value_start + value_length + 1;
                                                        __private(this).bytes_already_parsed = attribute_end;
                                                        break;
                                                    default:
                                                        value_start = __private(this).bytes_already_parsed;
                                                        value_length = strcspn(this.html, "> 	\
                                                            n\ ", value_start);
                                                            attribute_end = value_start + value_length; __private(this).bytes_already_parsed = attribute_end;
                                                        }
                                                } else {
                                                    value_start = __private(this).bytes_already_parsed;
                                                    value_length = 0;
                                            ...
                                            if (!array_key_exists(comparable_name, __private(this).attributes)) {
                                                __private(this).attributes[comparable_name] = new WP_HTML_Attribute_Token(attribute_name, value_start, value_length, attribute_start, attribute_end, !has_value);
                                            }
                                            return true;
                                        };
                                        var __skip_whitespace = function() {
                                                __private(this).bytes_already_parsed += strspn(this.html, " 	\
                                                    n\ ", __private(this).bytes_already_parsed);
                                                };
                                                var __after_tag = function() {
                                                    this.get_updated_html();
                                                    __private(this).tag_name_starts_at = null;
                                                    __private(this).tag_name_length = null;
                                                    __private(this).tag_ends_at = null;
                                                    __private(this).is_closing_tag = null;
                                                    __private(this).attributes = {};
                                                };
                                                var __class_name_updates_to_attributes_updates = function() {
                                                    if (count(__private(this).classname_updates) === 0) {
                                                        return;
                                                    }
                                                    var existing_class;
                                                    existing_class = __private(this).get_enqueued_attribute_value.call(this, "class");
                                                    if (null === existing_class || true === existing_class) {
                                                        existing_class = "";
                                                    }
                                                    if (false === existing_class && isset(__private(this).attributes["class"])) {
                                                        existing_class = substr(this.html, __private(this).attributes["class"].value_starts_at, __private(this).attributes["class"].value_length);
                                                    }
                                                    ...
                                                    __loop1:
                                                        while (at < existing_class_length) {
                                                            ...
                                                            ws_at = at;
                                                            var ws_length;
                                                            ws_length = strspn(existing_class, " 	\
                                                                n\ ", ws_at);
                                                                at += ws_length;
                                                                // Capture the class name – it's everything until the next whitespace.
                                                                var name_length; name_length = strcspn(existing_class, " 	\
                                                                    n\ ", at);
                                                                    if (0 === name_length) {
                                                                        // If no more class names are found then that's the end.
                                                                        break;
                                                                    }
                                                                    var name; name = substr(existing_class, at, name_length); at += name_length;
                                                                    // If this class is marked for removal, start processing the next one.
                                                                    var remove_class; remove_class = isset(__private(this).classname_updates[name]) && WP_HTML_Tag_Processor.REMOVE_CLASS === __private(this).classname_updates[name];
                                                                    // If a class has already been seen then skip it; it should not be added twice.
                                                                    if (!remove_class) {
                                                                        __private(this).classname_updates[name] = WP_HTML_Tag_Processor.SKIP_CLASS;
                                                                    }
                                                                    if (remove_class) {
                                                                        modified = true;
                                                                        continue;
                                                                     ...
                                                                     */
                                                                    class += substr(existing_class, ws_at, ws_length); class += name;
                                                                }
                                                                // Add new classes by appending those which haven't already been seen.
                                                                __loop1:
                                                                for (name in __private(this).classname_updates) {
                                                                    var operation;
                                                                    operation = __private(this).classname_updates[name];
                                                                    if (WP_HTML_Tag_Processor.ADD_CLASS === operation) {
                                                                        modified = true;
                                                                        class += strlen(class) > 0 ? " " : "";
                                                                        class += name;
                                                                    }
                                                                }
                                                                __private(this).classname_updates = {};
                                                                if (!modified) {
                                                                    return;
                                                                }
                                                                if (strlen(class) > 0) {
                                                            ...
                                                            var __apply_attributes_updates = function(shift_this_point) {
                                                                if (typeof shift_this_point == 'undefined') shift_this_point = 0;
                                                                if (!count(this.lexical_updates)) {
                                                                    return 0;
                                                                }
                                                                var accumulated_shift_for_given_point;
                                                                 ...
                                                                 */
                                                                usort(this.lexical_updates, {
                                                                    0: WP_HTML_Tag_Processor.class,
                                                                    1: "sort_start_ascending"
                                                                });
                                                                var bytes_already_copied;
                                                                bytes_already_copied = 0;
                                                                var output_buffer;
                                                                output_buffer = "";
                                                                var _key_;
                                                                __loop1:
                                                                    for (_key_ in this.lexical_updates) {
                                                                        var diff;
                                                                        diff = this.lexical_updates[_key_];
                                                                        var shift;
                                                                        shift = strlen(diff.text) - (diff.end - diff.start);
                                                                        // Adjust the cursor position by however much an update affects it.
                                                                        if (diff.start <= __private(this).bytes_already_parsed) {
                                                                            __private(this).bytes_already_parsed += shift;
                                                                        }
                                                                 ...
                                                                 */
                                                                __loop1:
                                                                    for (_key_ in this.bookmarks) {
                                                                        var bookmark;
                                                                        bookmark = this.bookmarks[_key_];
                                                                        /*
                                                            ...
                                                            var __sort_start_ascending = function(a, b) {
                                                                var by_start;
                                                            ...
                                                            var __get_enqueued_attribute_value = function(comparable_name) {
                                                            ...
                                                            var __parse_query = function(query) {
                                                                if (null !== query && query === __private(this).last_query) {
                                                                    return;
                                                                }
                                                                __private(this).last_query = query;
                                                                __private(this).sought_tag_name = null;
                                                                __private(this).sought_class_name = null;
                                                                __private(this).sought_match_offset = 1;
                                                                __private(this).stop_on_tag_closers = false;
                                                                // A single string value means "find the tag of this name".
                                                                if (is_string(query)) {
                                                                    __private(this).sought_tag_name = query;
                                                                    return;
                                                                }
                                                                ...
                                                                if (!is_array(query)) {
                                                                    _doing_it_wrong('WP_HTML_Tag_Processor::parse_query', __("The query argument must be an array or a tag name."), "6.2.0");
                                                                    return;
                                                                }
                                                                if (isset(query["tag_name"]) && is_string(query["tag_name"])) {
                                                                    __private(this).sought_tag_name = query["tag_name"];
                                                                }
                                                                if (isset(query["class_name"]) && is_string(query["class_name"])) {
                                                                    __private(this).sought_class_name = query["class_name"];
                                                                }
                                                                if (isset(query["match_offset"]) && is_int(query["match_offset"]) && 0 < query["match_offset"]) {
                                                                    __private(this).sought_match_offset = query["match_offset"];
                                                                }
                                                                if (isset(query["tag_closers"])) {
                                                                    __private(this).stop_on_tag_closers = "visit" === query["tag_closers"];
                                                                }
                                                            };
                                                            var __matches = function() {
                                                                if (__private(this).is_closing_tag && !__private(this).stop_on_tag_closers) {
                                                                    return false;
                                                                }
                                                                // Does the tag name match the requested tag name in a case-insensitive manner?
                                                                if (null !== __private(this).sought_tag_name) {
                                                                    /*
                                                                     * String (byte) length lookup is fast. If they aren't the
                                                                     * same length then they can't be the same string values.
                                                                     */
                                                                    if (strlen(__private(this).sought_tag_name) !== __private(this).tag_name_length) {
                                                                        return false;
                                                                    }
                                                                    /*
                                                                    ...
                                                                    var i;
                                                                    __loop1:
                                                                        for (i = 0; i < __private(this).tag_name_length; i++) {
                                                                            var html_char;
                                                                            html_char = this.html[__private(this).tag_name_starts_at + i];
                                                                            var tag_char;
                                                                            tag_char = __private(this).sought_tag_name[i];
                                                                            if (html_char !== tag_char && strtoupper(html_char) !== tag_char) {
                                                                                return false;
                                                                            }
                                                                        }
                                                                }
                                                                var needs_class_name;
                                                                needs_class_name = null !== __private(this).sought_class_name;
                                                                if (needs_class_name && !isset(__private(this).attributes["class"])) {
                                                                    return false;
                                                                }
                                                                /*
                                                                ...
                                                                if (needs_class_name) {
                                                                    var class_start;
                                                                    class_start = __private(this).attributes["class"].value_starts_at;
                                                                    var class_end;
                                                                    class_end = class_start + __private(this).attributes["class"].value_length;
                                                                    var class_at;
                                                                     ...
                                                                     */
                                                                    __loop1:
                                                                        while (false !== (class_at = strpos(this.html, __private(this).sought_class_name, class_at)) && class_at < class_end) {
                                                                            /*
                                                                            ...
                                                                            if (class_at > class_start) {
                                                                                ...
                                                                                if (" " !== character && "	" !== character && "" !== character && "
                                                                                    " !== character && "\
                                                                                    n\ " !== character){
                                                                                    class_at += strlen(__private(this).sought_class_name);
                                                                                    continue;
                                                                                }
                                                                            }
                                                                            /*
                                                                             ...
                                                                             */
                                                                            if (class_at + strlen(__private(this).sought_class_name) < class_end) {
                                                                                character = this.html[class_at + strlen(__private(this).sought_class_name)];
                                                                                if (" " !== character && "	" !== character && "" !== character && "
                                                                                    " !== character && "\
                                                                                    n\ " !== character){
                                                                                    class_at += strlen(__private(this).sought_class_name);
                                                            ...
                                                            function WP_HTML_Tag_Processor(html) {
                                                                 ...
                                                                 * @type {array|null}
                                                                 */
                                                                __private(this).last_query = null;
                                                                /**
                                                                 ...
                                                                 * @type {int|null}
                                                                 */
                                                                __private(this).sought_match_offset = null;
                                                                /**
                                                                 ...
                                                                 * @type {bool}
                                                                 */
                                                                __private(this).stop_on_tag_closers = null;
                                                                /**
                                                                 ...
                                                                 * @type {int}
                                                                 */
                                                                __private(this).bytes_already_parsed = 0;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).skip_rcdata = __skip_rcdata;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).skip_script_data = __skip_script_data;
                                                                /**
                                                                 * Parses the next tag.
                                                                 *
                                                                 ...
                                                                 */
                                                                __private(this).parse_next_tag = __parse_next_tag;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).parse_next_attribute = __parse_next_attribute;
                                                                /**
                                                                 ...
                                                                 * @return void
                                                                 */
                                                                __private(this).skip_whitespace = __skip_whitespace;
                                                                /**
                                                                 ...
                                                                 * @return void
                                                                 */
                                                                __private(this).after_tag = __after_tag;
                                                                /**
                                                                 ...
                                                                 * @return void
                                                                 */
                                                                __private(this).class_name_updates_to_attributes_updates = __class_name_updates_to_attributes_updates;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).apply_attributes_updates = __apply_attributes_updates;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).sort_start_ascending = __sort_start_ascending;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).get_enqueued_attribute_value = __get_enqueued_attribute_value;
                                                                /**
                                                                 ...
                                                                 * @return void
                                                                 */
                                                                __private(this).parse_query = __parse_query;
                                                                /**
                                                                 ...
                                                                 */
                                                                __private(this).matches = __matches;
                                                                if (__isInheritance == false) {
                                                                    this.__construct(html);
                                                                }
                                                            }
                                                            WP_HTML_Tag_Processor.MAX_BOOKMARKS = 10;
                                                            WP_HTML_Tag_Processor.MAX_SEEK_OPS = 1000;
                                                            WP_HTML_Tag_Processor.ADD_CLASS = true;
                                                            WP_HTML_Tag_Processor.REMOVE_CLASS = false;
                                                            WP_HTML_Tag_Processor.SKIP_CLASS = null;
                                                            /**
                                                             * Constructor.
                                                             *
                                                             * @since 6.2.0
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.__construct = function(html) {
                                                                this.html = html;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.next_tag = function(query) {
                                                                if (typeof query == 'undefined') query = null;
                                                                __private(this).parse_query.call(this, query);
                                                                var already_found;
                                                                already_found = 0;
                                                                __loop1:
                                                                    do {
                                                                        ...
                                                                        if (false === __private(this).parse_next_tag.call(this)) {
                                                                            __private(this).bytes_already_parsed = strlen(this.html);
                                                                            return false;
                                                                        }
                                                                        ...
                                                                        var tag_ends_at;
                                                                        tag_ends_at = strpos(this.html, ">", __private(this).bytes_already_parsed);
                                                                        if (false === tag_ends_at) {
                                                                            return false;
                                                                        }
                                                                        __private(this).tag_ends_at = tag_ends_at;
                                                                        __private(this).bytes_already_parsed = tag_ends_at;
                                                                        // Finally, check if the parsed tag and its attributes match the search query.
                                                                        if (__private(this).matches.call(this)) {
                                                                            ++already_found;
                                                                        }
                                                                        /*
                                                                         ...
                                                                         */
                                                                        var t;
                                                                        t = this.html[__private(this).tag_name_starts_at];
                                                                        if (!__private(this).is_closing_tag && ("s" === t || "S" === t || "t" === t || "T" === t)) {
                                                                            var tag_name;
                                                                            tag_name = this.get_tag();
                                                                            if ("SCRIPT" === tag_name && !__private(this).skip_script_data.call(this)) {
                                                                                __private(this).bytes_already_parsed = strlen(this.html);
                                                                                return false;
                                                                            } else if (("TEXTAREA" === tag_name || "TITLE" === tag_name) && !__private(this).skip_rcdata.call(this, tag_name)) {
                                                                                __private(this).bytes_already_parsed = strlen(this.html);
                                                                                return false;
                                                                            }
                                                                        }
                                                                    } while (already_found < __private(this).sought_match_offset);
                                                                return true;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.set_bookmark = function(name) {
                                                                if (null === __private(this).tag_name_starts_at) {
                                                                    return false;
                                                                }
                                                                if (!array_key_exists(name, this.bookmarks) && count(this.bookmarks) >= WP_HTML_Tag_Processor.MAX_BOOKMARKS) {
                                                                    _doing_it_wrong('WP_HTML_Tag_Processor::set_bookmark', __("Too many bookmarks: cannot create any more."), "6.2.0");
                                                                    return false;
                                                                }
                                                                this.bookmarks[name] = new WP_HTML_Span(__private(this).tag_name_starts_at - (__private(this).is_closing_tag ? 2 : 1), __private(this).tag_ends_at);
                                                                return true;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.release_bookmark = function(name) {
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.seek = function(bookmark_name) {
                                                                if (!array_key_exists(bookmark_name, this.bookmarks)) {
                                                                    _doing_it_wrong('WP_HTML_Tag_Processor::seek', __("Unknown bookmark name."), "6.2.0");
                                                                    return false;
                                                                }
                                                                if (++this.seek_count > WP_HTML_Tag_Processor.MAX_SEEK_OPS) {
                                                                    _doing_it_wrong('WP_HTML_Tag_Processor::seek', __("Too many calls to seek() - this can lead to performance issues."), "6.2.0");
                                                                    return false;
                                                                }
                                                                // Flush out any pending updates to the document.
                                                                this.get_updated_html();
                                                                // Point this tag processor before the sought tag opener and consume it.
                                                                __private(this).bytes_already_parsed = this.bookmarks[bookmark_name].start;
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.get_attribute = function(name) {
                                                                if (null === __private(this).tag_name_starts_at) {
                                                                    return null;
                                                                }
                                                                var comparable;
                                                                 ...
                                                                 */
                                                                if ("class" === name) {
                                                                    __private(this).class_name_updates_to_attributes_updates.call(this);
                                                                }
                                                                // Return any enqueued attribute value updates if they exist.
                                                                var enqueued_value;
                                                                enqueued_value = __private(this).get_enqueued_attribute_value.call(this, comparable);
                                                                if (false !== enqueued_value) {
                                                                    return enqueued_value;
                                                                }
                                                                if (!isset(__private(this).attributes[comparable])) {
                                                                    return null;
                                                                }
                                                                var attribute;
                                                                attribute = __private(this).attributes[comparable];
                                                                /*
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.get_attribute_names_with_prefix = function(prefix) {
                                                                if (__private(this).is_closing_tag || null === __private(this).tag_name_starts_at) {
                                                                    return null;
                                                                }
                                                                var comparable;
                                                                ...
                                                                var _key_;
                                                                __loop1:
                                                                    for (_key_ in array_keys(__private(this).attributes)) {
                                                                        var attr_name;
                                                                        attr_name = array_keys(__private(this).attributes)[_key_];
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.get_tag = function() {
                                                                if (null === __private(this).tag_name_starts_at) {
                                                                    return null;
                                                                }
                                                                var tag_name;
                                                                tag_name = substr(this.html, __private(this).tag_name_starts_at, __private(this).tag_name_length);
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.is_tag_closer = function() {
                                                                return __private(this).is_closing_tag;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.set_attribute = function(name, value) {
                                                                if (__private(this).is_closing_tag || null === __private(this).tag_name_starts_at) {
                                                                    return false;
                                                                }
                                                                /*
                                                                 ...
                                                                 */
                                                                if (preg_match("~[" + "\"'>&</ =" + "\\x{00}-\\x{1F}" + "\\x{FDD0}-\\x{FDEF}" + "\\x{FFFE}\\x{FFFF}\\x{1FFFE}\\x{1FFFF}\\x{2FFFE}\\x{2FFFF}\\x{3FFFE}\\x{3FFFF}" + "\\x{4FFFE}\\x{4FFFF}\\x{5FFFE}\\x{5FFFF}\\x{6FFFE}\\x{6FFFF}\\x{7FFFE}\\x{7FFFF}" + "\\x{8FFFE}\\x{8FFFF}\\x{9FFFE}\\x{9FFFF}\\x{AFFFE}\\x{AFFFF}\\x{BFFFE}\\x{BFFFF}" + "\\x{CFFFE}\\x{CFFFF}\\x{DFFFE}\\x{DFFFF}\\x{EFFFE}\\x{EFFFF}\\x{FFFFE}\\x{FFFFF}" + "\\x{10FFFE}\\x{10FFFF}" + "]~Ssu", name)) {
                                                                    _doing_it_wrong('WP_HTML_Tag_Processor::set_attribute', __("Invalid attribute name."), "6.2.0");
                                                                    return false;
                                                                }
                                                                /*
                                                                ...
                                                                if (true === value) {
                                                                    var updated_attribute;
                                                                    updated_attribute = name;
                                                                } else {
                                                                    var escaped_new_value;
                                                                ...
                                                                if (isset(__private(this).attributes[comparable_name])) {
                                                                    /*
                                                                     ...
                                                                     *     Result: <div id="new"/>
                                                                     */
                                                                    var existing_attribute;
                                                                    existing_attribute = __private(this).attributes[comparable_name];
                                                                     ...
                                                                     *     Result: <div id="new"/>
                                                                     */
                                                                    this.lexical_updates[comparable_name] = new WP_HTML_Text_Replacement(__private(this).tag_name_starts_at + __private(this).tag_name_length, __private(this).tag_name_starts_at + __private(this).tag_name_length, " " + updated_attribute);
                                                                }
                                                                /*
                                                                 ...
                                                                 */
                                                                if ("class" === comparable_name && !empty(__private(this).classname_updates)) {
                                                                    __private(this).classname_updates = {};
                                                                }
                                                                return true;
                                                            };
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.remove_attribute = function(name) {
                                                                if (__private(this).is_closing_tag) {
                                                                    return false;
                                                                }
                                                                /*
                                                                 ...
                                                                 * enqueued class changes from `add_class` and `remove_class`.
                                                                 */
                                                                if ("class" === name && count(__private(this).classname_updates) !== 0) {
                                                                    __private(this).classname_updates = {};
                                                                }
                                                                /*
                                                                 ...
                                                                 */
                                                                if (!isset(__private(this).attributes[name])) {
                                                                    if (isset(this.lexical_updates[name])) {
                                                                        delete this.lexical_updates[name];
                                                                    }
                                                                    return false;
                                                                }
                                                                /*
                                                                 ...
                                                                 *    Result: <div />
                                                                 */
                                                                this.lexical_updates[name] = new WP_HTML_Text_Replacement(__private(this).attributes[name].start, __private(this).attributes[name].end, "");
                                                                return true;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.add_class = function(class_name) {
                                                                if (__private(this).is_closing_tag) {
                                                                    return false;
                                                                }
                                                                if (null !== __private(this).tag_name_starts_at) {
                                                                    __private(this).classname_updates[class_name] = WP_HTML_Tag_Processor.ADD_CLASS;
                                                                }
                                                                return true;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.remove_class = function(class_name) {
                                                                if (__private(this).is_closing_tag) {
                                                                    return false;
                                                                }
                                                                if (null !== __private(this).tag_name_starts_at) {
                                                                    __private(this).classname_updates[class_name] = WP_HTML_Tag_Processor.REMOVE_CLASS;
                                                                }
                                                                return true;
                                                            };
                                                            /**
                                                             ...
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.__toString = function() {
                                                             ...
                                                             * @return string The processed HTML.
                                                             */
                                                            WP_HTML_Tag_Processor.prototype.get_updated_html = function() {
                                                                var requires_no_updating;
                                                                requires_no_updating = 0 === count(__private(this).classname_updates) && 0 === count(this.lexical_updates);
                                                                /*
                                                                 ...
                                                                 */
                                                                var before_current_tag;
                                                                before_current_tag = __private(this).tag_name_starts_at - 1;
                                                                /*
                                                                 * 1. Apply the enqueued edits and update all the pointers to reflect those changes.
                                                                 */
                                                                __private(this).class_name_updates_to_attributes_updates.call(this);
                                                                before_current_tag += __private(this).apply_attributes_updates.call(this, before_current_tag);
                                                                /*
                                                                ...
                                                                var previous_parsed_byte_count;
                                                                previous_parsed_byte_count = __private(this).bytes_already_parsed;
                                                                var previous_query;
                                                                previous_query = __private(this).last_query;
                                                                // Reparse attributes.
                                                                __private(this).bytes_already_parsed = before_current_tag;
                                                                this.next_tag();
                                                                // Restore previous state.
                                                                __private(this).bytes_already_parsed = previous_parsed_byte_count;
                                                                __private(this).parse_query.call(this, previous_query);
                                                                return this.html;
                                                            };
                                                            WP_HTML_Tag_Processor.class = 'WP_HTML_Tag_Processor';
